define("fetch/base_163", ["require", "exports", "module"], function (require, exports, module) {
// @@@@@@@@@@@@@@@@@@@@@@@@@@
  ...
  // http://quotes.money.163.com/hs/service/diyrank.php?fields=SYMBOL%2CNAME%2C&query=STYPE&sort=SYMBOL&order=asc&type=query&count=24
  // CODE
  // 沪深A股  http://quotes.money.163.com/hs/service/diyrank.php?page=0&query=STYPE%3AEQA&sort=SYMBOL&order=asc&count=5000&type=query

  // 获得 页数 列表
  var get_page_list = function () {
    var xhr = $.ajaxSettings.xhr();
    return do_get('http://quotes.money.163.com/hs/service/diyrank.php?page=0&query=STYPE%3AEQA&sort=SYMBOL&order=asc&count=5000&type=query',
      {dataType: "json"}
    ).then(function (e) {
